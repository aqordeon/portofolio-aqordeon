...
<template>
    <div class="relative group">
        ...
        <div class="bottom-0 left-0 xpx-2 w-full flex gap-x-2 flex-wrap mb-4">
            <div v-for="tag in product.tags" :key="tag" class="inline-flex items-center gap-x-1 rounded select-none px-2 py-0 text-xs w-fit font-medium border"
                :style="[
